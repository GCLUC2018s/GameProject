...
void CNetWork::StartServer(unsigned long port, bool udp) {
	m_udp = udp;
	// winsock2の初期化
...
bool CNetWork::StartClient(unsigned long port, const char *ipAddr, bool udp) {
	m_udp = udp;
	// winsock2の初期化
	WSAStartup(MAKEWORD(2, 0), &m_wsaData);
...
CSocket* CNetWork::GetClient(int idx) {
