...
void CAnimImage::SetAnimationSpeed(int speed) {
	m_animSpeed = speed;
}
...
void CAnimImage::Draw() {
	if (m_animData) {
		float x = m_pat_width * (m_animData[m_animJam].pData[m_animIndex].pat % (m_width / abs((int)m_pat_width)));
		float y = m_pat_height * (m_animData[m_animJam].pData[m_animIndex].pat / (m_width / abs((int)m_pat_width)));
