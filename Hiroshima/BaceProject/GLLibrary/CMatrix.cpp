...
CMatrix CMatrix::MTranselate(CVector3D& v) {
	CMatrix m;
...
CMatrix CMatrix::MScale(CVector3D& v) {
	CMatrix m;
	m.Scale(v.x, v.y, v.z);
	return m;
}
...
CMatrix CMatrix::MRotation(CVector3D& r) {
...
CMatrix CMatrix::MRotationAxis(CVector3D& v, float r) {
	CMatrix m;
