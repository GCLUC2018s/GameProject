...
void Init(void)
{
	...
	CSound::GetInstance();
	//初期化
	ADD_RESOURCE("Player", CAnimImage::LoadImage("player_motion.png", player_AnimData, 512, 512));
	...
	ADD_RESOURCE("Enemy4", CAnimImage::LoadImage("zako_kamaitachi_motion_kari.png", kamaitachi_AnimData, 512, 512));
