...
void CSceneManager::MainScene(){
	...
	new CEnemy1(&(CVector3D(200, 0, -300)));
	new CEnemy2(&(CVector3D(200, 100, -100)));
	new CEnemy3(&(CVector3D(100, 100, -250)));
	new CEnemy4(&(CVector3D(300, 50, -200)));
	new CEnemy5(&(CVector3D(400, 0, -130)));
