...
void CSceneManager::MainScene() {
	...
	new CItemBox(&(CVector3D(200, 0, -200)),rand()%2);
	new CItemBox(&(CVector3D(900, 0, -20)), rand() % 2);
	new CItemBox(&(CVector3D(1500, 0, -320)), rand() % 2);
	new CItemBox(&(CVector3D(2300, 0, -120)), rand() % 2);
	new CItemBox(&(CVector3D(2500, 0, -50)), rand() % 2);
	new CItemBox(&(CVector3D(2600, 0, -0)), rand() % 2);
