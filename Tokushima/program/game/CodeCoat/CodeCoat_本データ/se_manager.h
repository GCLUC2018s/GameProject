...
const int SE_COUNT = 10;

enum SND_NAME{TITLE_BGM = 0,STAGE_BGM,RANKING_BGM,CLEAR_SE,OVER_SE,JUMP_SE,SHOT_SE,SHOT2_SE,EMPTY_SE,KNIFE_SE,ITEM_SE,DAMAGE_SE,GET_SE};
